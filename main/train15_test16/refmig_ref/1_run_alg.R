...
# Lframe
# Rframe
load("data/refmig_ref/Lframe.RData")
load("data/refmig_ref/Rframe.RData")
...
# Employment one year arrival
saveRDS(LRtoOMout_2, file.path("output/refmig_ref/employment_one_year/", "LRtoOMout_2.rds"))


# Employment two year arrival
# saveRDS(LRtoOMout_3, file.path("output/refmig_ref/employment_two_year/", "LRtoOMout_3.rds"))
