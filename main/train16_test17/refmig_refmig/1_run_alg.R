...
# Lframe
# Rframe
load("data/train16_test17/refmig_refmig/Lframe.RData")
load("data/train16_test17/refmig_refmig/Rframe.RData")
...
# Employment one year arrival
saveRDS(LRtoOMout_2, file.path("output/train16_test17/refmig_refmig/employment_one_year/", "LRtoOMout_2.rds"))
