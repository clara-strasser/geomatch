...
# Rframe
Rframe <- data %>%
  filter(immiyear >= 2017 & refugee_sample == 1)
...
# Lframe: 10.974
save(Lframe, file = "data/train16_test17/refmig_ref/Lframe.RData")

# Rframe: 432
save(Rframe, file = "data/train16_test17/refmig_ref/Rframe.RData")
